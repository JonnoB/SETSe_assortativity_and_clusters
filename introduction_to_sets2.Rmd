...
process_facebook_embeddings(file.path(PLwd, "facebook_embeddings" ,"facebookbicomp"), 
                            file.path(PLwd, "facebook_embeddings" , "HPC_embeddings"))
process_facebook_embeddings(file.path(PLwd, "facebook_embeddings", "facebookbicomp"), 
                            file.path(PLwd, "facebook_embeddings", "HPC_embeddings_auto"))
