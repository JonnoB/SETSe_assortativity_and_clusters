...
embedded_files <- list.files(file.path(PLwd, "peel_benchmark_embeddings8"), full.names = T)
...
node2vec_embeds <- list.files(file.path(PLwd, "node2vec_embeddings8"), full.names = TRUE)
